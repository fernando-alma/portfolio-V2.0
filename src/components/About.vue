<script setup>
import profilePic from '/src/assets/img/foto_perfil.jpeg'; // Imagen de perfil
</script>
...
<template>
  <div class="about-section">
    ...
    <div class="content">
      <!-- Lado izquierdo en desktop / Primera sección en mobile -->
      <div class="left-section">
        <!-- Imagen de perfil en forma circular -->
        <img class="profile-image" :src="profilePic" alt="Imagen de perfil">
        ...
        <div class="buttons-container">
          ...
          <a href="/cv/Fernando_Gonzalo_Alma_Dileo_CV_Harvard.pdf" download class="download-btn">
            Descargar CV
          </a>

          <!-- Botón de portfolio completo -->
          <router-link to="/portfolio-completo" class="download-btn portfolio-btn">
        ...
        <div class="social-icons">
          <a href="https://github.com/fernando-alma" target="_blank" class="icon github">
            <i class="fab fa-github"></i>
          </a>
          <a href="https://www.linkedin.com/in/fernando-alma" target="_blank" class="icon linkedin">
            <i class="fab fa-linkedin"></i>
          </a>
          <a href="https://wa.me/+5492615407274" target="_blank" class="icon whatsapp">
            <i class="fab fa-whatsapp"></i>
          </a>
        </div>
      </div>

      <!-- Lado derecho en desktop / Segunda sección en mobile -->
      <div class="right-section">
        <div class="about-info">
          ...
          <p class="description">
            ...
            Durante mi trayectoria he desarrollado más de 30 proyectos en agencia y varios de forma independiente bajo mi
            marca personal <strong>Soulware</strong>, trabajando con tecnologías como Java, Spring Boot, React, Node.js,
            MySQL, WordPress y WooCommerce.

            Me destaco por mi capacidad para resolver problemas, adaptarme a nuevas tecnologías y mantener una
            comunicación efectiva con clientes y equipos de trabajo. Mi objetivo es aportar soluciones digitales
            escalables, eficientes y alineadas con las necesidades del negocio, mientras continúo creciendo en entornos
            profesionales que me desafíen y potencien mis habilidades técnicas y de liderazgo.
          </p>
        </div>
      </div>
    </div>
...
.about-section::before {
  ...
  transform: scaleX(-1); /* espeja solo el fondo */
...
/* SECCIÓN IZQUIERDA - Foto, título, botones, redes */
.left-section {
  flex: 1;
  display: flex;
...
@media (max-width: 768px) {
  ...
  .description {
    text-align: center; /* Centrar descripción en mobile */
  }
